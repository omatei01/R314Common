...
public interface MfaDevice extends BaseService { // FiscalPrinterService114
	 ...
	 * 
	 * @param companyName  numele companiei ex: LEONARDO ROMANIA SRL
	 * @param storeName    numele magazinului ex: MAGAZIN AFI COTROCENI
	 * @param address      adresa line 1: STR. DR. IACOB FELIX, NR.8-10
	 * @param address2     adresa line 2: SECTOR 1, BUCURESTI
	 * @param companyCif   cif companie/store: CIF RO6205722
	 * @param bnrCode      cod statistic BNR: XXX.XX.XXX.XX [doar pt exchange]
	 * @param amefFiscalId logo fiscal: 9000028216
	 ...
	 * <p>
	 * 
	 * @param vatRate        format int pentru procent: 15 % - 0.15 *10000 = 1500
	 * @param pNeplatitorTva daca e neplatitor sau nu ; daca e true at va ignora vatRate
	 * @throws JposException <br>
	 ...
	 * @param address2    s
	 * @param companyCif  s
	 * @param bnrCod      s; la retail este optional
	 * @throws JposException <br>
	 ...
	 * 
	 * @param inoutHeaderLines output string array .
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_EXTENDED + <i>codeExtended</i>=MFA_ERRX_WRONG_STATE: mfa in stare gresita<br>
	 */
	 ...
	 * 
	 * @param pHeaderLines lines
	 * @param print        daca print nonfiscal receipt
	 * @throws JposException <br>
	 ...
	 * 
	 * @param trailerLines Texts to which to set the trailer line.
	 * @param print        daca print nonfiscal
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MfaConst.MFA_ERR_EXTENDED + <i>codeExtended</i>=MFA_ERRX_WRONG_STATE: mfa in stare gresita<br>
	 ...
	 * 
	 * @param trailerLines String array
	 * @throws JposException e
	 */
	 ...
	 * 
	 * @param date datatimp in fomrmat yyyyMMddHHmm.
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_FAILURE: erori grave la scriere in mem.fisc.<br>
	 *                       <i>errorCode</i>=MFA_ERR_ILLEGAL: tip gresit mfa<br>
	 ...
	 * <p>
	 * 
	 * @param dataType vezi mai sus valorile
	 ...
	 * 
	 * @param posId Identifier for the POS system (max len 2)
	 * @param print daca da sau nu
	 * @throws JposException <br>
	 ...
	 * apiValidation(monitor:true, write:true, needFiscal: false, needDayClosed: false, needZ: false);
	 * 
	 * @param cashierId   0 sau un cod
	 * @param cashierName "" sau un nume
	 * @param print       daca da sau nu bon
	 * 
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_FAILURE: erori grave la scriere in mem.fisc.<br>
	 ...
	 * 
	 * @param customer         numele si prenumele clientului de ex VASILE ION
	 * @param country          țara fie cod, fie denumire. de ex RO
	 * @param identityID       serie si numar act de identitate. de ex CI RX 552345
	 * @param CNP              cnp nume 5551235464646
	 * @param rezident         da sau nu
	 * @param amount           suma neta -fara comision -cumparată/vinduta: 25678 (256.78 * 100)
	 * @param valuta           valuta pentru suma cumparata; altceva decit ron(text gen EUR, RON etc)
	 * @param curs             curs in ron si 4 zecimale; 47895 (4.7895 * 10000)
	 * @param unit             unitatea pentru curs: 100 leva = 1 ron
	 * @param comissionPercent procent comision; 1000 (10% adică 0.10 * 10000)
	 * @param inoutAmountsMfa  array cu sumele calculate de mfa
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_ILLEGAL: Acest MFA nu este de tip EXCHANGE<br>
	 ...
	 * @param amount           suma neta -fara comision -cumparată/vinduta: 25678 (256.78 * 100)
	 * @param valuta           valuta pentru suma cumparata; altceva decit ron(text gen EUR, RON etc)
	 * @param curs             curs in ron si 4 zecimale; 47895 (4.7895 * 10000); NU INCLUDE COMISION
	 * @param unit             denominator/ 100 leva = CURS
	 * @param comissionPercent procent comision; 1000 (10% adică 0.10 * 10000)
	 * @param inoutAmountsMfa  array cu sumele calculate din mfa: comision, baza de calcul, suma finala
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_ILLEGAL: Acest MFA nu este de tip EXCHANGE<br>
	 *                       <i>errorCode</i>=MFA_ERR_EXTENDED + <i>codeExtended</i>=MFA_ERRX_VAT_REQUIRED:MFA nu are tva programat<br>
	 *                       <i>errorCode</i>=MFA_ERR_FAILURE: erori grave la scriere in mem.fisc.<br>
	 ...
	 * apiValidation(monitor:true, write:true, needFiscal: true, needDayClosed: false, needZ: true);
	 * 
	 * @param type        int FPTR_RT_CASH_IN(1) or FPTR_RT_CASH_OUT(2) .
	 * @param amount      amount; always positive
	 * @param currency    text for currency
	 * @param description EXPLICATII sau empty
	 * @param name        nume si prenume sau empty
	 * @param identityId  act identitate tip, serie, numar
	 * @param issuer      emitent (vezi alimentari) sau empty
	 * @param recipient   destinatar (vezi alimentari) sau empty
	 * @param operType    operatiune (de ex plata la deconturi) sau empty
	 * 
	 ...
	 * apiValidation(monitor:true, write:true, needFiscal: true, needDayClosed: false, needZ: false)
	 * 
	 * @throws JposException vezi mai jos<br>
	 *                       <i>errorCode</i>=MFA_ERR_ILLEGAL: Acest MFA nu este de tip EXCHANGE<br>
	 ...
	 * 
	 * @param reportType 1=MFA_REP_TR_SUMAR or 2=MFA_REP_TR_DETAILED
	 * @param filterFlag combinatii de
	 *                   MFA_REP_TF_EOD_ORDINAL, MFA_REP_TF_EOD_ORDINAL, MFA_REP_TF_FLAG_INCLUDE_PROBA, MFA_REP_TF_FLAG_ONLY_PROBA
	 * @param start      ASCII string identifying the starting record in Fiscal Printer memory from which to begin printing
	 * @param stop       ASCII string identifying the final record in Fiscal Printer memory at which printing is to end.
	 *                   See reportType table below to find out the exact meaning of this parameter.
	 * @param outputType 1=MFA_REP_OUTPUT_PRINT, 2=MFA_REP_OUTPUT_FILE, 3=MFA_REP_OUTPUT_EMAIL
	 * @throws JposException <br>
	 ...
	 * apiValidation(monitor:true, write:false, needFiscal: true, needDayClosed: false, needZ: false);
	 * 
	 * @param filterType combinatii de
	 *                   MFA_REP_TF_EOD_ORDINAL, MFA_REP_TF_EOD_ORDINAL, MFA_REP_TF_FLAG_INCLUDE_PROBA, MFA_REP_TF_FLAG_ONLY_PROBA
	 * @param start      ASCII string with data/z number
	 * @param stop       ASCII string with data/z number
	 *                   See reportType table below to find out the exact meaning of this parameter.
	 * @param outputType 1=MFA_REP_OUTPUT_PRINT, 2=MFA_REP_OUTPUT_FILE, 3=MFA_REP_OUTPUT_EMAIL
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_NOHARDWARE: Lipseste stick usb<br>
	 ...
	 * Print intotdeauna
	 * 
	 * @throws JposException e daca nu e fiscal, daca param sunt gresiti; daca stick lipseste etc
	 */
	 ...
	 * @param format vezi constante print tranzact
	 * @throws JposException <br>
	 *                       <b>ErrorCode</b> <br>
	 *                       E_EXTENDED:<br>
	 ...
	 * @throws JposException <i>ErrorCode</i> <br>
	 */
	 ...
	 * 
	 * @param totalizerType totalizer type; see values permited
	 ...
	 * 
	 * @param printHeader Indicates if the header lines are to be printed at this time; for normal use = true.
	 * @throws JposException e
	 */
	 ...
	 * <p>
	 * 
	 * @param printAllLines daca tipareste toate liniile bonului
	 * @param printHeader   daca se tipareste header; daca e false se tipareste la sfirsit, vezi endFiscalReceipt
	 * @throws JposException
	 */
	 ...
	 * 
	 * @param description denumire articol
	 * @param quantity    cantitate
	 * @param unitName    unitatea de masura; max 3 chars
	 * @param unitPrice   pretul unitar cu tva
	 * @param vatInfo     cota de tva: A, B, C, D, E sau S, sau T
	 * @throws JposException e
	 */
	 ...
	 * @param description denumire articol
	 * @param quantity    cantitate
	 * @param vatInfo     cota de tva
	 * @param unitPrice   pret unitar
	 * @param unitName    unitatea de masura; max 3
	 * @throws JposException e
	 */
	 ...
	 * @param description    text optional pentru descriere err
	 * @param amount         suma sau procent penrtu reducere/adaos
	 * @param vatInfo        cota de tva
	 * @throws JposException e
	 */
	 ...
	 * Se poate combina cu preline/postline<br>
	 * 
	 * @param adjustmentType Type of adjustment to be voided. {@link #printRecItemAdjustment(int, String, long, char)}
	 ...
	 * 
	 * @param adjustmentType Type of adjustment. See below for values. The adjustmentType parameter has one of the following values (Note: If currency value, four decimal places
	 *                       are used):<br>
	 ...
	 * @param description    text care descrie reducerea (optional)
	 * @param amount         suma pozitiva coresp reducerii sau adaosului (discount or surcharge).
	 * @throws JposException e
	 */
	 ...
	 * 
	 * @param total       totalul bonului din aplicatie
	 * @param payment     suma de plata
	 * @param paymentType tip plata /index
	 * @param description optional, o descriere a platii
	 * @throws JposException e
	 */
	 ...
	 * 
	 * @param description mesaj optional
	 * @throws JposException
	 */
	 ...
	 * Dupa printare se reseteaza automat<br>
	 * 
	 * @param preLine array cu linii de print
	 * @throws JposException e
	 */
	 ...
	 * 
	 * @param vatRate       int[5] vatRate array cu procentele de tva;
	 * @param neplatitorTva daca e neplatitor de tva sau nu
	 * @throws JposException <br>
	 *                       <i>errorCode</i>=MFA_ERR_FAILURE: erori grave la scriere in mem.fisc.<br>
	 *                       <i>errorCode</i>=MFA_ERR_EXTENDED + <i>codeExtended</i>=MFA_ERRX_WRONG_STATE: mfa in stare gresita
	 *                       <i>errorCode</i>=MFA_ERR_EXTENDED + <i>codeExtended</i>=MFA_ERRX_DAY_END_REQUIRED: operatia nu se poate realiza in timpul zilei fiscale
	 ...
	 * <p>
	 * 
	 * @param vatRateInputOutput predef size 5
	 * @throws JposException
	 */
	 ...
	 * 
	 * @param pathFile trbuie sa existe acest file
	 * @throws JposException
	 */
	 ...
	 * 
	 * @param xmlType    0 - deocamdata nefolosit
	 * @param filterType 1 sau 2 - vezi mfaConst
	 ...
	 * 
	 * @param filterType MFA_REP_TF_EOD_ORDINAL = 1 (rap dupa nr) sau MFA_REP_TF_DATE = 2 (rap dupa data)
	 * @param start      in fc de filterType, nr Z start sau data in format yyyyMM, pt luna raport
	 * @param stop       in fc de filtertType, nr Z stop sau empty pentru data stop caci nu conteaza
	 * @throws JposException ex
	 */
	 ...
	 * @param start      in fc de filterType, nr Z start sau data in format yyyyMM, pt luna raport
	 * @param stop       in fc de filtertType, nr Z stop sau empty pentru data stop caci nu conteaza
	 * @param outputType MFA_REP_OUTPUT_FILE=2 sau MFA_REP_OUTPUT_EMAIL = 3
	 * @throws JposException ex
	 * 
	 */
	 ...
	 * Genereaza setul de fisiere xml si fie il pune pe stick, fie il trimite ca zip pe email<br>
	 * 
	 * @param xmlType    0; nefolosit
	 * @param filterType MFA_REP_TF_EOD_ORDINAL = 1 (rap dupa nr) sau MFA_REP_TF_DATE = 2 (rap dupa data)
	 * @param start      in fc de filterType, nr Z start sau data in format yyyyMM, pt luna raport
	 * @param stop       in fc de filtertType, nr Z stop sau empty pentru data stop caci nu conteaza
	 * @param outputType MFA_REP_OUTPUT_FILE=2 sau MFA_REP_OUTPUT_EMAIL = 3
	 * @param emailBody  conteaza doar cu MFA_REP_OUTPUT_EMAIL, un text optional; altfel empty
	 * @param automat    conteaza doar cu MFA_REP_OUTPUT_EMAIL; altfel false
	 * @throws JposException
	 */
	 ...
	 * 
	 * @param data continut fisier/date de salvat
	 * @throws JposException ex
	 */
	 ...
	 * 
	 * @param inoutData valoare returnata; size =getUserDataSize
	 * @throws JposException ex
	 */
	 ...
	 * pk.pem si cert.pem
	 * 
	 * @param pathToFolder aici tr sa se gaseasca files!!
	 ...
	 * 
	 * @param timeoutSeconds in secunde
	 * @return cantitatea sau -1
	 * @throws JposException
	 * 
	 */
	 ...
	 * 
	 * @param amount suma de plata in format numeric intreg - deci e suma* 100
	 * @return da sau nu
	 * @throws JposException erori de seriala sau protocol
	 */
	@Deprecated
	 ...
	 * 
	 * @param docPlataID id palat din backoffice
	 * @param amount
	 * @return
	 * @throws JposException
	 */
	 ...
	 * 
	 * @param id eftId de validat
	 * @return da sau nu
	 * @throws JposException daca lista de eft este in curs de incarcare
	 */
